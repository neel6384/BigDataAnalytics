...
public class NewsKMeansClustering {
  ...
  public static void main(String args[]) throws Exception {
    ...
    String inputDir = "hdfs://localhost:54310/Clustering/reuters_seq/";
    Configuration conf = new Configuration();
    conf.set("fs.default.name", "hdfs://localhost:54310/");
    FileSystem fs = FileSystem.get(conf);

    String outputDir = "hdfs://localhost:54310/Clustering/Kmeans";
    ...
    TFIDFConverter.processTfIdf(
      new Path(outputDir , DictionaryVectorizer.DOCUMENT_VECTOR_OUTPUT_FOLDER),
      new Path(outputDir), conf, dfData, minDf,maxDFPercent, norm, true, sequentialAccessOutput, false, reduceTasks);
