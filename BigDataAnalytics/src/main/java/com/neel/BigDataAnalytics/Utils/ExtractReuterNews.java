 ...
 * Date, Dateline, Body
 */
public class ExtractReuterNews {
  private File reutersDir;
  private File outputDir;
  private static final String LINE_SEPARATOR = System.getProperty("line.separator");

  public ExtractReuterNews(File reutersDir, File outputDir) {
  ...
  /*  if (args.length != 2) {
    ...
    File reutersDir = new File("/home/neel/reuters21578");
    ...
    // to output directory.
    File outputDir = new File("/home/neel/reuters_text");
    outputDir = new File(outputDir.getAbsolutePath() + "-tmp");
    outputDir.mkdirs();
    ExtractReuterNews extractor = new ExtractReuterNews(reutersDir, outputDir);
    extractor.extract();
    // Now rename to requested output dir
    outputDir.renameTo(new File("/home/neel/reuters_text"));
  }
